...
// GetPlaylistChartResponse getPlaylistChartResponseFromJson(String str) => GetPlaylistChartResponse.fromJson(json.decode(str));

// String getPlaylistChartResponseToJson(GetPlaylistChartResponse data) => json.encode(data.toJson());
...
//     factory GetPlaylistChartResponse.fromJson(Map<String, dynamic> json) => _$GetPlaylistChartResponseFromJson(json);
...
// final creatorTypeValues = EnumValues({
